...
export default (props) => html`
    <div class="vertical-center">
        <p class="main-paragraph">
            ...
            the ground up, especially with the plethora of frameworks that are
            overkill for many projects and websites.<br /><br />
            Long live the handmade web.
        </p>
        <br /><br /><br />
        <a href="https://github.com/BL451/blap64">
            Click this to view the code for this website
        </a>
    </div>
`;
